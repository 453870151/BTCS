  ...
  static async mintExperienceMachine(address, CoinTokenAddress, contractsAddress, price, priceBig) {
    try {
      ...
      if (Number(coinBalance) < 1) {
        ...
        ContractShenma.message.error((_ContractShenma$i18n2 = ContractShenma.i18n) == null ? void 0 : _ContractShenma$i18n2.t('Experience Coin Insufficient balance'));
        return;
      }
...
const MiningProvider = _ref => {
  ...
  const [miningRemainingTotal, setMiningRemainingTotal] = (0,react.useState)(10); // 剩余可购买矿机数
